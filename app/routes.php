<?php
	...
	// programmation page
	$app->get('/prog/', "LMQP\Controller\HomeController::incomingAction")->bind('prog');
	// booking page
	$app->match('/booking/', "LMQP\Controller\HomeController::bookingAction")->bind('booking');
	// history page
	$app->get('/histo/', "LMQP\Controller\HomeController::incomingAction")->bind('histo');
	// useful information page
	$app->get('/infos/', "LMQP\Controller\HomeController::incomingAction")->bind('infos');
	// partner page
	$app->get('/part/', "LMQP\Controller\HomeController::incomingAction")->bind('part');
	// press page
